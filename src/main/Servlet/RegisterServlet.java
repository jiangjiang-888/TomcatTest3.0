...
import main.Bean.RegisterFormBean;
...
public class RegisterServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(act!=null&&act.equals("modify"))
		{
			...
			{
				ActionUtils.WriteDownActions("user",user.getUserName(),user.getIp(),"修改个人信息");
				request.getRequestDispatcher("/userInformation.jsp").forward(request, response);
				return;
			}
...
//			System.out.print("注册成功");
			ActionUtils.WriteDownActions("user",userBean.getUserName(),userBean.getIp(),"查看购物车");
