...
<div class="hover" style="background-color:#D56F2B;height:38px; line-height:38px; color:white; text-align:right;padding-right:250px; font-size:15px;" >  
	...
	<div class="wrap">
		<aside id="left">
			<div class="div"
				style="background-color: white; color: #D56F2B; height: 50px; line-height: 50px; border-top-left-radius: 7px; text-align: center;">
				...
				<c:forEach items="${cart}" var="s" varStatus="vs">
					...
					<div class="cart">
						...
						<div class="CartItemPrice">
							￥${s.itemPrice}*${s.buyNumber } <br> <br> <a href="ListItemServlet?act=delete&itemId=${s.itemId}">删除</a>
						</div>
		...
		<section id="right">
			...
			<div>
				...
				<ul>
					...
					<li><a href="ListItemServlet?itemName=带">涂改带</a></li>
					<li><a href="ListItemServlet?itemName=尺">尺子</a></li>
					<li>
			...
			<div style="overflow-x: auto; overflow-y: auto; height: 550px; width: 100% ; background-color:#F7F7F7">
					...
					<img src=${s.filename } style="height:100%;width:100%;margin:0 auto;">
					</div>
					...
					<a  href="ItemAddCartServlet?itemid=${s.itemId }&number=1&itemName=<%=request.getSession().getAttribute("itemName")%>"><img style="height:24px;float:right;" src="image/cart.jpg"></a>
					</div>
					</div>
					</c:forEach>
